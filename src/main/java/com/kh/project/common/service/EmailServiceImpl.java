...
import com.kh.project.common.vo.EmailDTO;


@Service // 서비스 빈으로 등록
public class EmailServiceImpl implements EmailService {
 
	private final static org.slf4j.Logger logger =LoggerFactory.getLogger(EmailServiceImpl.class);
...
//            helper.setText("<html><body><img src='cid:identifier1234'></body></html>", true);
            ...
            e.printStackTrace();
            System.out.println("이메일 서비스의 실패 캐치!!!!!!!!!!!!!!");
        }
    }
}
